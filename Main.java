...
public class Main {
    ...
    public static void nextSong(ListIterator<Song> it){
        if (it.hasNext()){
            it.next();
            if (it.hasNext()){
    ...
    public static void prevSong(ListIterator<Song> it){
        if (it.hasPrevious()){
    ...
    public static void currentSong(ListIterator<Song> it, LinkedList<Song> playlist){
        if(!playlist.isEmpty()){
